  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the convenience of B2C Car Sharing v2. Book cars near you, managed by dedicated operations staff through centralized dashboards. Seamless travel, just a click away."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the convenience of B2C Car Sharing v2. Book cars near you, managed by dedicated operations staff through centralized dashboards. Seamless travel, just a click away.`}
            </Text>
            <Box
